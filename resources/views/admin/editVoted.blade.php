...
@section('content')
    <form onsubmit="console.log('submitted')" action="{{ route('admin.pemira.update', ['voted' => $voted->id]) }}"
                ...
                <div class="bg-white rounded-2xl shadow-lg p-6 sticky top-6">
                    ...
                    <div class="mb-4">
                        <div id="avatarPreview"
                            ...
                            <img src="{{ $voted->avatar }}" alt="Preview" class="w-full h-full object-cover">
                        </div>
                ...
                <div class="bg-white rounded-2xl shadow-lg p-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="{{ $voted->name }}" required
                        ...
                        <div>
                            ...
                            <input type="text" name="nim" id="nim" value="{{ $voted->nim }}" required
                                maxlength="18"
                        ...
                        <div>
                            ...
                            <textarea name="vision" id="vision" rows="4" required
                                ...
                                placeholder="Tuliskan visi kandidat...">{{ $voted->vision }}</textarea>
                            @error('vision')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
